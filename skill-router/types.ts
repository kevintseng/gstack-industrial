...
export interface SkillMatcher {
  ...
  executionHints?: string[];     // Static guidance on how to execute this skill
  roleContext?: string;          // Role definition injected into Claude when skill is invoked
  autoDiscovered?: boolean;      // True if generated by auto-discover, false if manually written
}
...
export interface SkillMatch {
  ...
  executionHints?: string[];     // Propagated from matcher
  roleContext?: string;          // Propagated from matcher
}

/**
 * Snapshot of router context saved when a suggestion is made,
 * restored when the user accepts ("yes") so Claude gets full context.
 */
